...
class AddLeadScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final selectedMaxHits = useState("");
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownSearch<String>(
                      validator: (value) {
                        if (checkEmpty(value)) {
                          return "Select max hits ";
                        } else {
                          return null;
                        }
                      },
                      selectedItem: selectedMaxHits.value.isEmpty
                          ? null
                          : selectedMaxHits.value,
                      popupProps:
                          const PopupProps.menu(showSelectedItems: true),
                      items:
                      ...
                      dropdownDecoratorProps: const DropDownDecoratorProps(
                        dropdownSearchDecoration: InputDecoration(
                          labelText: "Max hits",
                          hintText: "Max hits from teachers",
                        ),
                      ),
                      onChanged: (value) {
                        selectedMaxHits.value = value!;
                      },
                    ),
                          ...
                          onPressed: () async {
                            formSubmitFunction(
                                ...
                                submitFunction: () async {
                                  Utils.loading(msg: "Creating new lead...");
